public class ValidadorEtapa3 {
	...
	public static void main(final String[] args){
		...
		//instância
		final Endereco e1 = new Endereco("Rua dos Bobos", "Piraporinha", "SC", "Uruguai", "99000-100", "0", "Fundos");
		...
		//instância
		final Data d1 = new Data(10, 3, 2023);
		...
		final Loja loja1 = new Loja ("E3", 5, 0, e1, d1, 0, 0);
		...
		final Produto p1 = new Produto("Cubo mágico", 10, d1);
		...
		final Cosmetico lojaCosmetico = new Cosmetico("Loja Cosmético", 10, 2100, e1, d1, 20);
		...
		//Criação da instância
		final Vestuario lojaVestuario = new Vestuario("Loja Vestuário", 10, 2100, e1, d1, false);
		...
		//Criação da instância
		final Bijuteria lojaBijuteria = new Bijuteria("Loja Bijuteria", 10, 2100, e1, d1, 5000);
		...
		//Criação da instância
		final Alimentacao lojaAlimentacao = new Alimentacao("Loja Alimentação", 10, 2100, e1, d1, d1);
		...
		//Criação da instância
		final Informatica lojaInformatica = new Informatica("Loja Informática", 10, 2100, e1, d1, 300);
		System.out.println("\n[OK] Classe Informatica identificada");
		
		//public void setSeguroEletronicos(double seguroEletronicos)
		lojaInformatica.setSeguroEletronico(500);
		System.out.println("[OK] Método Informatica.setSeguroEletronicos()");
		
		//public double getSeguroEletronicos()
		System.out.println(lojaInformatica.getSeguroEletronico() == 500 ? "[OK] Método Informatica.getSeguroEletronicos()" : "[NOK] Método Informatica.getSeguroEletronicos()");
