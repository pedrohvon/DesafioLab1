public class ValidadorEtapa4 {
	...
	public static void main(String[] args){
		...
		Loja loja1 = new Loja ("E3", 5, 0, e1, d1, 0, 0);
		System.out.println("\n[OK] Classe Loja identificada (construtor com cinco parâmetros)");
		
		Loja loja2 = new Loja ("E7", 20, 2000, e1, d1, 2, 0);
		...
		Loja lojaCosmetico = new Cosmetico("Loja Cosmético", 10, 2100, e1, d1, 20);
		...
		lojaInformatica.setSeguroEletronico(800);
		...
		Loja maisCaro = (Loja) shopping.lojaSeguroMaisCaro();
		System.out.println(((Informatica) maisCaro).getSeguroEletronico() == 800 ? "[OK] Método Shopping.lojaSeguroMaisCaro()" : "[NOK] Método Shopping.lojaSeguroMaisCaro");
